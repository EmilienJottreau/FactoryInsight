            ...
            if await tags["operating_state"].read_value():
                if not await tags["emergency_stop"].read_value():
                    ...
                    if await tags["heating_state"].read_value():
                        ...
                        if await tags["liquid_level"].read_value() > 0 and await tags["liquid_temperature"].read_value() > 0:
                            await tags["liquid_temperature"].change_value(await tags["liquid_temperature"].read_value() - gauss(1, 0.6))
